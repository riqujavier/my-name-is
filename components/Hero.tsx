        ...
        <section className="min-h-[80vh] flex flex-col justify-center items-center text-center py-20 relative px-4">
            <div className="relative z-10 space-y-6 flex flex-col items-center">
                ...
                <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <a href="/Javier_Riquelme_CV_EN.pdf" target="_blank" rel="noopener noreferrer" className="px-8 py-3 outline-none rounded-full bg-indigo-600/80 border border-indigo-400/50 hover:bg-indigo-500 backdrop-blur-md transition-all duration-300 text-white font-medium shadow-[0_0_15px_rgba(79,70,229,0.3)] hover:shadow-[0_0_25px_rgba(79,70,229,0.5)] flex items-center justify-center gap-2 w-full sm:w-auto">
